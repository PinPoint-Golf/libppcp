...
| **Status** | **Specified, not yet reviewed.** Sent to PinPointCapture and PinPointStudio for review against their own codebases, capped at **three review rounds** by explicit instruction — see §6 |
