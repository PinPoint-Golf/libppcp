...
Both first-party teams reviewed Draft 1 and both returned **approve to implement**. The reviews are in [`reviews/`](./) and are worth reading in full; this section records what was done with each finding.
