...
| Status | **APPROVED for implementation**, 22 August 2026. Revision 9, final — see [`CORE` Annex D](ppcp-core.md#annex-d--change-history) — **plus errata E1–E39**, all normative, listed in [`CORE`'s errata table](ppcp-core.md#errata-after-revision-9). E30–E39 are `PPCP-RV` only — E30–E33 from [CR-01](../changerequests/CR-01-disposition.md), E34–E39 from [its review pass](../changerequests/CR-01-review-response.md) |
| Date | 22 August 2026; errata to 24 August 2026 |
| Errata | **39** — E1–E29 from implementation sessions S1–S5, E30–E33 from change request [CR-01](../changerequests/CR-01-disposition.md), E34–E39 from [its review pass](../changerequests/CR-01-review-response.md) |
...
**Thirty-nine errata, E1–E39.** E1–E29 came from implementation sessions S1–S5; E30–E39 came from [CR-01](../changerequests/CR-01-disposition.md), the first change request — E30–E33 the grant, E34–E39 the review pass both teams ran over it — which is a different thing and is grouped separately below. Grouped by what they were:
