...
| Status | **APPROVED for implementation**, 22 August 2026. Revision 9, final — see [`CORE` Annex D](ppcp-core.md#annex-d--change-history) — **plus errata E1–E55**, all normative, listed in [`CORE`'s errata table](ppcp-core.md#errata-after-revision-9). E30–E48 are `PPCP-RV` only — E30–E33 from [CR-01](../changerequests/CR-01-disposition.md), E34–E51 from its [four](../changerequests/CR-01-review-response.md) [review](../changerequests/CR-01-review-response-2.md) [passes](../changerequests/CR-01-review-response-3.md) ([fourth](../changerequests/CR-01-review-response-4.md)), including E48 closing [B17](../changerequests/CR-01-x25519-seam.md) |
| Date | 22 August 2026; errata to 24 August 2026 |
| Errata | **55** — E1–E29 from implementation sessions S1–S5, E30–E33 from change request [CR-01](../changerequests/CR-01-disposition.md), E34–E51 from its [four](../changerequests/CR-01-review-response.md) [review](../changerequests/CR-01-review-response-2.md) [passes](../changerequests/CR-01-review-response-3.md) ([fourth](../changerequests/CR-01-review-response-4.md)), E67–E69 from the 2 September 2026 clock-convergence work ([5.4d](ppcp-core.md#54-timebaserelation), [6.3c1, 6.3f1, 6.3g1](ppcp-core.md#63-clock-synchronisation)) |
...
| — | [**PPCP-RV**](ppcp-rv.md) | Normative when agreed | Rendezvous, pairing, security. **APPROVED**, revision 9 — five review passes on §1–§10, **no open findings there**. Revision 9's [§11, RV-6](ppcp-rv.md#11-rv-6--guided-pairing) is new under [CR-01](../changerequests/CR-01-disposition.md) and has had **five** review passes and twenty-six findings. Passes 2 and 3 each found a defect the previous pass's fix had introduced; pass 4 found nothing in the clauses and split [RT-20](ppcp-rv.md#9-conformance) so two thirds of it runs before either application writes a line; **pass 5 ran RT-20a for the first time — the property held and the number describing it was 4.86% wrong.** [Dispositioned separately](reviews/rv-review-disposition-2026-08-22.md). Versioned separately from PPCP |
...
| — | [**Review disposition**](reviews/review-disposition-2026-08-22.md) | Record | Every review comment across all three rounds, what was done with it, and the calls a reviewer may want to reverse |
...
| **The number, and the first run** | E54, E55 | **RT-20a was executed the same afternoon the row was split — after four passes reporting RT-20 unmoved — over 200 000 interposer quadruples: zero collisions, digits uniform at χ² 933.6/999.** The property held; **the bound did not.** *One chance in 1 048 576* is 2⁻²⁰, the width of `sas_raw` rather than of the six digits an attacker must match — the true figure is 1 in 1 000 000, **4.86% weaker**, found independently by both teams and computed identically. It also shows the modulo bias never reaches the bound, which E42 claimed and could not demonstrate. RT-20a is now **deterministic** against a published interposer quadruple, so the one test touching the security property needs no curve. E55 carries E53 into 3.4d3: a persisted pairing has **no expiry**, so size rotation on pairings *held*. |
| **A premise nobody checked** | E53 | ⛔ **The largest finding in CR-01 and the only one no review pass could have caught.** The request was granted for *"a venue where a range operator sets up several bays"* — **and that deployment does not exist.** The host is never at the range; a capture device there works standalone and its session travels home as a bundle. So the venue problem three passes escalated as *the thing deciding whether RV-6 was worth building* never arose. No clause changes — nothing in §11 ever depended on where the peers stood — and RV-6 is kept on a narrower, honest justification. **Four passes, two teams, twenty findings, and not one asked whether the situation the request described was real**: every reviewer inherited it from the request, and so did the owner. |
...
The full disposition of all three rounds, including what was **not** actioned and why, is in [`review-disposition-2026-08-22.md`](reviews/review-disposition-2026-08-22.md).
